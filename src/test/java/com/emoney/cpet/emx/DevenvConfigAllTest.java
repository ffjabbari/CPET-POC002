...
public class DevenvConfigAllTest {
	...
	public void test() {
		...
		ObjectFactory<DevenvConfig> configFactory = new ObjectFactory();
		...
		DevenvConfig clientContext = configFactory.create(DevenvConfig.class.getName(), mapParam);

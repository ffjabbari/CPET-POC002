...
public class DatabaseConfigAllTest {
	...
	public void test() {
		...
		ObjectFactory<DatabaseConfig> configFactory = new ObjectFactory();
		...
		DatabaseConfig clientContext = configFactory.create(DatabaseConfig.class.getName(), mapParam);

...
public class SecurityServiceImplTest {
	...
	public void test() {
		...
		ObjectFactory<SecurirtyServiceImpl> configFactory = new ObjectFactory();
		...
		SecurirtyServiceImpl clientContext = configFactory.create(SecurirtyServiceImpl.class.getName(), mapParam);

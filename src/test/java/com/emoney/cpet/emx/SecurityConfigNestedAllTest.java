...
public class SecurityConfigNestedAllTest {
	...
	public void test() {
		...
		ObjectFactory<SecurityConfigNested> configFactory = new ObjectFactory();
		Map<String, Object> mapParam = new HashMap<String, Object>();

		mapParam.put(SecurityConfigNested.class.getName() + ".field1", "field1V");
		mapParam.put(SecurityConfigNested.class.getName() + ".field2", "field2V");
		mapParam.put(SecurityConfigNested.class.getName() + ".field3", "field3V");
		...
		SecurityConfigNested clientContext = configFactory.create(SecurityConfigNested.class.getName(), mapParam);
